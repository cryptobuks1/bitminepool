          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 class="style4">Welcome to Bit Mine Pool</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 class="style3">Generate Starter Pack Invoice</h2>
                    					<?php
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask" action="payment/invoice" method="Post">
                     ...
                     <label class="control-label col-md-3 col-sm-3 col-xs-12">Invoice Purpose</label>
                       <div class="col-md-3 col-sm-9 col-xs-12">
                         <input type="text" class="form-control" name="Purpose" id="Purpose" readonly="readonly" value="Starter">
                       </div>
                      </div>
                      <div class="form-group">
                     ...
                     <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <button type="submit" name="submitbutton" class="btn btn-success"><i class="fa fa-share-square-o"></i> Generate Invoice</button>
