              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="edituser" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input id="Fullname" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" value="<?php echo $showname;?>" name="name" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="email" id="email" name="email" required="required" value="<?php echo $showemail;?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input id="phone" type="tel" value="<?php echo $showtelephone;?>" name="Telephone">
