                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
					  ...
					  <?php 
					  $mediumdate= "SELECT MiningDate FROM mediumpack WHERE Username='".$_SESSION['Username']."'";
					  ...
					  ?>
						<?php
									$i=1;
									$query = mysqli_query($conn,"select * from dailymine where Pack='Medium'and Date Between '$showmediumdate' AND '$Currentmining'");
