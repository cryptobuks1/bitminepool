...
/////////////////////////////Get Withdrawal Balance for Pool 1/////////////////////////////////////////////////////////////
		$getwstarter = "SELECT Withdrawal FROM minipack WHERE Username = '".$_SESSION['Username']."'";
...
/////////////////////////////Get Withdrawal Balance for Pool 1/////////////////////////////////////////////////////////////
$Starterdate1= "SELECT MiningDate FROM minipack WHERE Username='".$_SESSION['Username']."'";
...
$querysum = "select sum(Usd)as total from dailymine where Pack='Mini' and Date Between '$showstarterdate1' AND '$Currentmining1'";
...
$sqlv = "UPDATE minipack SET Withdrawal='$newbalance' WHERE Username='".$_SESSION['Username']."'";
