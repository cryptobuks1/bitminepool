          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Daily Mining Earnings <small>Grand Pack</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      This are the Daily Earnings From Grand Pack Mining Contract.
                    </p>
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                      ...
                      <tbody>
					  <?php 
					  $granddate= "SELECT MiningDate FROM grandpack WHERE Username='".$_SESSION['Username']."'";
					  ...
					  ?>
                        <?php
									$i=1;
									$query = mysqli_query($conn,"select * from dailymine where Pack='Grand'and Date Between '$showgranddate' AND '$Currentmining'");
