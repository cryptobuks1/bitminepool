...
<html lang="en">
  <head>
	...
	<style>
		...
		.error_password_pattern_special {
			color: gray;
			opacity: 0.7;
			padding-left: 90px;
			font-size: 12px;
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" id="first_form" novalidate action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">

                      
                     
                      <span class="section">Member Registration: Step 1</span>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" id="label_fullname" for="name">Full Name <span class="required">*</span>
                        </label>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" id="label_email" for="email">Email <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" id="label_confirm_email" for="email">Confirm Email <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                     ...
                     <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" id="label_username" for="occupation">Username <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="password" id="label_password" class="control-label col-md-3">Password</label>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label for="password2" id="label_confirm_password" class="control-label col-md-3 col-sm-3 col-xs-12">Repeat Password</label>
                        <div class="col-md-3 col-sm-6 col-xs-12">
  ...
  <script src="jquery_trial_v1.js"></script>
