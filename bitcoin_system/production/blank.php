                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input id="Sponsor" type="text" name="Sponsor" data-validate-length-range="5,20" readonly="true" value="<?php echo $_SESSION['Sponsorname'];?>"class="optional form-control col-md-7 col-xs-12">
                        </div>
                      </div>
