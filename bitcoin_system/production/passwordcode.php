              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate action="searchpassword" method="post">

                      
                     
                      <span class="section">Password Recovery</span>
                      <h3>Step 3 Enter Password Verification Code</h3>
<p>Note: The email may take upto 1 hour and also check the SPAM folder before contacting support.</p>
                      ...
                      <div class="ln_solid"></div>
                        ...
                        <button id="send" type="submit" class="btn btn-success">Verify Code</button>
                      </div>           
                      <div class="ln_solid"></div>
