...
$querysum = "select sum(Usd)as total from dailymine where Pack='Medium' and Date Between '$showstarterdate1' AND '$Currentmining1'";
...
$sqlv = "UPDATE mediumpack SET Withdrawal='$newbalance' WHERE Username='".$_SESSION['Username']."'";
