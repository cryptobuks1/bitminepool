        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"> <span><img src="images/logo.png" alt="Bitcoin-Mine-Hub" style="width: 95px;"></span></a>
            </div>
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span><a href="guest.php">Welcome,</a></span>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 class="style3">How to upgrade your account</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Upgrading Procedure</h2>
                    
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      <p>Step 1: Sign up for the $100 Membership Package by clicking the link below.</p>
                       <p>By upgrading your account you can now be able to purchase various products that are available at Bitcoin Mine Hub</p>
                        <a href="genregister"><button type="button" class="btn btn-success btn-lg">Upgrade Account Now</button></a>
                  </div>
                </div>
              </div>
            </div>
