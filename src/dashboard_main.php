                ...
                <div class="row tile_count">
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                       ...
                       <!-- <div class="count"><a href="#"><?php echo $totalone; ?></a></div> -->
                        <div class="count"><a href="statement/1/0"><?php echo $selectedAccountBalance; ?></a></div>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        ...
                        <!-- <div class="count"><a href="#"><?php echo $totaltwo; ?></a></div> -->
                         <div class="count"><a href="statement/1/5"><?php echo $selectedMiningBalance; ?></a></div>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        ...
                        <div class="count"><a href="statement/1/4"><?php echo $selectedTeamBalance; ?></a></div>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                       ...
                       <!-- <div class="count"><a href="#"><?php echo $totalfour; ?></a></div> -->
                        <div class="count"><a href="statement/1/1"><?php echo $selectedCommissionBalance; ?></a></div>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        ...
                        <div class="count"><a href="statement/1/2"><?php echo $selectedBinaryIncomeBalance; ?></a></div>
