<?php
include('bitcoin_system/production/includes/constant.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="slider-content s-tb slide-1">
                     <div class="title-container s-tb-c">
                        ...
                        <div class="slider-btn-area">
                            <a href="bitcoin_system/production/login" class="default-big-btn">Start today</a>
                        </div>
                    </div>
                </div>
            </div>
	              ...
	              <div class="thumb">
	                <img class="full-width" alt="" src="img/causes/service-6.png">
	              	...
	              	<div class="causes-details clearfix">
		                ...
		                <div>
		                 <a class="thm-btn btn-xs" href="bitcoin_system/production/login">Buy now</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-12 md-text-center">
					...
					<a href="bitcoin_system/production/login" class="thm-btn inverse mb-md-40">Be a part of us</a>
				</div>
				...
				<div class="col-sm-6 col-md-4">
					<div class="event-post">
						<div class="thumb">
							...
							<div class="overlay">
								<a href="bitcoin_system/production/login">Join Us</a>
						...
						<div class="img-box">
							...
							<div class="overlay">
								<div class="box">
									<div class="content">
										<ul>
											<li><a href="bitcoin_system/production/login"><i class="fa fa-link"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
